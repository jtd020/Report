...
if True:
    ...
    (initial_g, initial_rb), (filtered_g, filtered_rb), (cleaned_g, cleaned_rb) = cleanup_and_eval_search_policy(search_policy, eval_env, 40)
    #
    ...
    visualize_search_path(search_policy, eval_env, difficulty=0.5)
    ...
    visualize_compare_search(agent, search_policy, eval_env, difficulty=0.5)